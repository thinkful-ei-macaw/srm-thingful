  ...
  const protectedEndpoints = [
    ...
    protectedEndpoints.forEach(endpoint => {
      describe(endpoint.name, () => {
        ...
        it('responds with 401 and Missing basic token message when basic token is missing', () => {
        ...
        it('responds 401 and Unauthorized request message when given no creds', () => {
          const userNoCreds = {
            user_name: '',
            password: ''
          }
        ...
        it('responds 401 and Unauthorized request message when given invalid user', () => {
